...
while hasFrame(shuttleVideo)
   ...
   fullname = fullfile(workingDir,'1',filename);
...
pathfolder = 'C:\Users\xxxxxx\1'%The folder of your images
path=[pathfolder];
...
for i=1:1000%% Set the needed numbers of images, from 1 to 100
